...
const Footer = () => {
    return (
    <footer className = "footer pt-24 pb-10 md:pb-20 md:pt-40 md:px-5 flex flex-col text-white fixed bottom-0 left-0 w-screen md:flex-row md:justify-between">
        ...
        <div className="md:mt-auto">
            <div className = "socialLinks md:justify-end mx-10 mt-10 pl-1 flex pb-3">
                <a className="group mr-5" href="https://www.instagram.com/pokebay_udistrict/" target="_blank" rel="noopener noreferrer">
                    <InstagramIcon />
                </a>
                <a className="group mr-5" href="" target="_blank" rel="noopener noreferrer">
                    <FacebookIcon />
                </a>
